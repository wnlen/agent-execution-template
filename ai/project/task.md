...
If the human provided only `ai/project/intake.md`, the agent may derive this task
contract from intake plus project context. Prefer safe assumptions over extra
questions, but do not guess scope, risk, permissions, or acceptance.
